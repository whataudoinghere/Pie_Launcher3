...
public class HotseatQsbView extends BaseQsbView {
    ...
    public static int getHotseatPadding(Launcher launcher) {
        ...
        return Math.round((((((((float) (barSizePx + bottomRect)) - rectValue) - ((((float) (((barSizePx + bottomRect) - hotseatLayoutPadding.top) - hotseatLayoutPadding.bottom)) + (((float) dp.iconSizePx) * 0.92f)) / 2.0f)) - resources.getDimension(R.dimen.qsb_widget_height)) + rectValue)));
    }
}
